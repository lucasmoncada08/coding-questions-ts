...
describe("test duplicate password code", () => {
    ...
    test("should be able to parse the type of query properly", () => {
        ...
        expect(duplicatePasswordChecker.parseInput(inputOne))
            .toEqual({inputType: "add", input: "aaa"});
        expect(duplicatePasswordChecker.parseInput(inputTwo))
            .toEqual({inputType: "query", input: "a"});
    })
    ...
    test("should handle a complex use case of multiple inputs", () => {
        ...
        expect(duplicatePasswordChecker.handlePasswordInputs(inputs))
            .toEqual([
                "0",
                "",
                "",
